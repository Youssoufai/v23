                            ...
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <p class="text-white">
                                    ...
                                    <span id="dots">...</span><span id="more">
                                        ...
                                        model and that the drive for profit doesn't supersede the social good. The above
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-57" src="img/4.png" style="object-fit: cover"
                            alt="" />
                    </div>
                </div>
